...
import NewRelease from "/NewRelease.png"
                            ...
                            <li key={clothes.id} className="collection-container-item">
                                <div className="product-card">
                                    <button className="clothing-link-placeholder">
                                        <img className={`clothing-image ${clothes.title}`} src={NewRelease} alt="" />
                                    </button>
                                    <div className="product-card-info">
                                        ...
                                        <button className="add-to-cart" onClick={ () => {
                                            handleAddProduct(clothes.id,clothes.title,clothes.price,NewRelease);
                                            toggleCartModal();
                                        }}>
                                            Add To Cart
                                        </button>
